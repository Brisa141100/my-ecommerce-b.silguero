    ...
    <div className="accordion accordion-flush letra2" id="accordionFlushExample">
      <div className="accordion-item">
        <h1 className="accordion-header" id="flush-headingOne">
          <button className="accordion-button collapsed letra letrawhite" type="button" data-bs-toggle="collapse"
        ...
        <div id="flush-collapseOne" className="accordion-collapse collapse" aria-labelledby="flush-headingOne"
          ...
          <div className="accordion-body letra letrablack">
            <table>
              <thead>
      ...
      <div className="accordion-item">
        ...
        <div id="flush-collapseTwo" className="accordion-collapse collapse" aria-labelledby="flush-headingTwo"
          data-bs-parent="#accordionFlushExample">
          <div className="accordion-body letra letrablack pdc2">
      ...
      <div className="accordion-item">
        ...
        <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree"
          data-bs-parent="#accordionFlushExample">
          <div class="accordion-body letra2 letra letrablack formc">
